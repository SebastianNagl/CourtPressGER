...
def main():
    ...
    generate_parser.add_argument("--batch-size", "-b", type=int, default=5, help="Anzahl der Elemente pro Batch (Standard: 5)")
    generate_parser.add_argument("--start-idx", "-s", type=int, default=0, help="Startindex für die Verarbeitung (Standard: 0)")
    generate_parser.add_argument("--save-interval", type=int, default=5, help="Speicherintervall für Checkpoints (Standard: 5)")
